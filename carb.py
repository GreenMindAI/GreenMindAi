...
if response.status_code == 200:
    ...
    # Check if the submission button is clicked
    if st.button("Submit"):
        try:
            ...
            st.write("Retirements for the Specified Month:", f"**{sum_retirements_this_month:,.0f}**")
            ...
            # Add attribution by GreenMindAI at the bottom
    st.markdown("<sub>App by GreenMindAI 😄</sub>", unsafe_allow_html=True)
